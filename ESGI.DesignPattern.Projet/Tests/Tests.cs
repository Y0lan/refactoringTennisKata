...
namespace ESGI.DesignPattern.Projet.Tests
{
    ...
    [TestFixture( 4,  0, "Win for P1")]
    [TestFixture( 0,  4, "Win for P2")]
    [TestFixture( 2,  1, "Thirty-Fifteen")]
    [TestFixture( 1,  2, "Fifteen-Thirty")]
    [TestFixture( 3,  1, "Forty-Fifteen")]
    [TestFixture( 1,  3, "Fifteen-Forty")]
    [TestFixture( 4,  1, "Win for P1")]
    [TestFixture( 1,  4, "Win for P2")]
    [TestFixture( 3,  2, "Forty-Thirty")]
    [TestFixture( 2,  3, "Thirty-Forty")]
    [TestFixture( 4,  2, "Win for P1")]
    [TestFixture( 2,  4, "Win for P2")]
    [TestFixture( 4,  3, "Advantage P1")]
    [TestFixture( 3,  4, "Advantage P2")]
    [TestFixture( 5,  4, "Advantage P1")]
    [TestFixture( 4,  5, "Advantage P2")]
    [TestFixture(15, 14, "Advantage P1")]
    [TestFixture(14, 15, "Advantage P2")]
    [TestFixture( 6,  4, "Win for P1")]
    [TestFixture( 4,  6, "Win for P2")]
    [TestFixture(16, 14, "Win for P1")]
    [TestFixture(14, 16, "Win for P2")]
    public class TennisTests
    {
        ...
        private void CheckAllScores(IGame game)
        {
    ...
    public class ExampleGameTennisTest
    {
        ...
        private void RealisticTennisGame(IGame game)
        {
